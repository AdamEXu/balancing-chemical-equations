...
import RemixGameLevel1 from './remix/RemixGameLevel1.js';
import RemixGameLevel2 from './remix/RemixGameLevel2.js';
import RemixGameLevel3 from './remix/RemixGameLevel3.js';
...
export default class GameModel implements TModel {
  ...
  public constructor( tandem: Tandem ) {
    ...
    console.log( `Remix mode: ${BCEQueryParameters.remix}` );
    if ( BCEQueryParameters.remix ) {
      console.log( 'Loading REMIX equation pools' );
      this.levels = [
      ...
      console.log( 'Loading ORIGINAL equation pools' );
      this.levels = [
